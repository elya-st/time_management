...
class NotesFacade(facade_abc.AbcFacade):
    ...
    def get_rows(self):
        return self.dml.select_star_sql(self._table_name)

    def delete_history(self):
        self.ddl.drop_table(self._table_name)
